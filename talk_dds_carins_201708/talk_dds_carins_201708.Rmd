...
crossval_tbl <- modelr::crossv_mc(usedata_tbl, 12, 0.25, id = 'fold_id') %>%
...
Want $(\mu, \text{dispersion}) \to (\alpha, \beta)$

\


\begin{eqnarray*}
\alpha &=& \frac{1}{\text{GLM dispersion}} \\
\beta  &=& \frac{\alpha}{\mu}
\end{eqnarray*}
...
Total size of dataset after filters:
...
claimfreq_assessment_tbl <- modelr::crossv_mc(trainpolicies_tbl
                                             ,assessment_count
                                             ,test = 0.25
                                             ,id = 'fold_id') %>%
