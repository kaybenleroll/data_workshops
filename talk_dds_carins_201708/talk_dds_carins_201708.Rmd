...
simulate_claim_data <- create_claim_simulator(model_02_glm, claimsize_glm)
```

```{r sanity_check_training, echo=FALSE}
insamp_assess_tbl <- simulate_claim_data(insamp_tbl, variable_claim_size = FALSE)
...
outsamp_assess_tbl <- simulate_claim_data(outsamp_tbl, variable_claim_size = FALSE)
