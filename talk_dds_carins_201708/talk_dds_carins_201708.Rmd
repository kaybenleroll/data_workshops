...
crossval_tbl <- modelr::crossv_mc(usedata_tbl, 12, 0.25) %>%
...
calculate_assessment_cumlprob <- function(train_tbl, valid_tbl) {
    ...
    cuml_prob <- ecdf(claim_count_sample)(observed_claim_count)
