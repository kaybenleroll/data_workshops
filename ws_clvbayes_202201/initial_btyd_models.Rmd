...
We have created customer cohorts based on when the customer first appeared on
the system. We now load this cohort data as it is 

```{r load_customer_cohort_data, echo=TRUE}
customer_cohort_data_tbl <- read_rds("data/customer_cohort_data_tbl.rds")
