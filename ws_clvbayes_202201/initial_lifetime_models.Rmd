...
```{r construct_posterior_palive_stats, echo=TRUE}
...
ltmodel_mintime_alive_tbl %>% glimpse()
```

Having constructed the dataset, we then construct the visualisation of the
proportions.

```{r construct_posterior_palive_stats_plot, echo=TRUE}
...
As before, it looks like we are overstating the probability of a customer
...
```{r write_mintime_stanfit_disk, echo=TRUE}
ltmodel_mintime_stanfit %>% write_rds("data/ltmodel_mintime_stanfit.rds")
```
...
```{r construct_posterior_palive_stats_minmax, echo=TRUE}
...
ltmodel_minmax_alive_tbl %>% glimpse()
```

Having constructed the dataset, we then construct the visualisation of the
proportions.

```{r construct_posterior_palive_stats_minmax_plot, echo=TRUE}
...
```{r write_minmax_stanfit_disk, echo=TRUE}
ltmodel_minmax_stanfit %>% write_rds("data/ltmodel_minmax_stanfit.rds")
```
...
```{r construct_posterior_palive_stats_tightprior, echo=TRUE}
...
ltmodel_tightprior_alive_tbl %>% glimpse()
```

Having constructed the dataset, we then construct the visualisation of the
proportions.

```{r construct_posterior_palive_stats_tightprior_plot, echo=TRUE}
...
```{r write_tightprior_stanfit_disk, echo=TRUE}
ltmodel_tightprior_stanfit %>% write_rds("data/ltmodel_tightprior_stanfit.rds")
```
...
```{r write_hier_stanfit_disk, echo=TRUE}
ltmodel_hier_stanfit %>% write_rds("data/ltmodel_hier_stanfit.rds")
```
...
```{r construct_posterior_palive_stats_hier_one, echo=TRUE}
...
ltmodel_hier_one_alive_tbl %>% glimpse()
```

Having constructed the dataset, we then construct the visualisation of the
proportions.

```{r construct_posterior_palive_stats_hier_one_plot, echo=TRUE}
...
```{r write_hier_one_stanfit_disk, echo=TRUE}
ltmodel_hier_one_stanfit %>% write_rds("data/ltmodel_hier_one_stanfit.rds")
```


# Construct Lifetime p_alive Comparison Plot
...
```{r construct_p_alive_model_comparison_plot, echo=TRUE}
