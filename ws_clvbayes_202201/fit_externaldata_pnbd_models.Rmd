...
Despite knowing the model is invalid, it is worth looking at the outputs of the
model to help us diagnose some issues to try to learn what might be occurring.
