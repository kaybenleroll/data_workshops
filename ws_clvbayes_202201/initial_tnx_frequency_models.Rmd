...
```{r fit_freqmodel_prior_2_stanmodel, echo=TRUE}
...
```{r fit_freqmodel_prior_subset, echo=TRUE}
...
```{r fit_freqmodel_prior_2_subset, echo=TRUE}
...
comparison_distrib_tbl    %>% write_rds("data/synthdata_singleyear_comparison_distrib_tbl.rds")
```
