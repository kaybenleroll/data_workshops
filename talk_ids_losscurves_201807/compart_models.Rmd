...
## Exponential Growth Model as an ODE system
- ODE solutions analagous to growth curve model:  
\
...
## Example Base Model Specification
...
## Example Outputs: Outstanding
![Outstanding PPIs](img/base_ppi_os.png){width=700px}

## Example Outputs: Paid
![Paid PPIs](img/base_ppi_pd.png){width=700px}

## Questions

- Is a Normal observation model appropriate?  

- Can we estimate a correlation between $RLR{i}$ and $RRF_{i}$?
  - What would this represent?  
  
- Can you think of further extensions?
