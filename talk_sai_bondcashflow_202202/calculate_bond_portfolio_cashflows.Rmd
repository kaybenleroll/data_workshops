...
We also want to be able to divide the portfolio by other factors, and so we
want to join that data onto the cashflow data.

```{r append_company_data, echo=TRUE}
...
cashflow_full_tbl %>%
  ...
  arrange(gics_sector_name, currency) %>%
