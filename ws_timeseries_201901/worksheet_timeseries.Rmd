...
One possible starting point for forecasting problems is to use linear
regression, much like any other predictive modelling with time as an input to
the regression. We account for seasonality by using the various calendar labels
