...
Use well-known \texttt{mtcars} dataset

\vspace{3mm}

<<cp_mtcars_data, echo=TRUE, cache=FALSE, results='show', warning=FALSE, message=FALSE>>=
head(mtcars)
@
\end{frame}
...
\begin{minipage}{5cm}
<<cp_mtcars_plot1_code, echo=TRUE, cache=FALSE, results='hide', warning=FALSE, message=FALSE>>=
pv <- ggplot(mpg, aes(x = displ, y = hwy)) +
    geom_point()
@
\end{minipage}
\begin{minipage}{5cm}
<<cp_mtcars_plot1_plot, echo=FALSE, cache=FALSE, results='show', warning=FALSE, message=FALSE, out.height='4cm', out.width='6cm'>>=
plot(pv)
@
\end{minipage}
\end{frame}
...
\begin{minipage}{5cm}
<<cp_mtcars_plot2_code, echo=TRUE, cache=FALSE, results='hide', warning=FALSE, message=FALSE>>=
pv <- ggplot(mpg, aes(x = displ, y = hwy, colour = class)) +
    geom_point()
@
\end{minipage}
\begin{minipage}{5cm}
<<cp_mtcars_plot2_plot, echo=FALSE, cache=FALSE, results='show', warning=FALSE, message=FALSE, out.height='4cm', out.width='6cm'>>=
plot(pv)
@
\end{minipage}
\end{frame}
...
\begin{minipage}{5cm}
<<cp_mtcars_plot3_code, echo=TRUE, cache=FALSE, results='hide', warning=FALSE, message=FALSE>>=
pv <- ggplot(mpg, aes(x = displ, y = hwy)) +
    geom_point() +
    facet_wrap(~class)
@
\end{minipage}
\begin{minipage}{5cm}
<<cp_mtcars_plot3_plot, echo=FALSE, cache=FALSE, results='show', warning=FALSE, message=FALSE, out.height='4cm', out.width='6cm'>>=
plot(pv)
@
\end{minipage}
\end{frame}
...
\begin{minipage}{5cm}
<<cp_mtcars_plot4_code, echo=TRUE, cache=FALSE, results='hide', warning=FALSE, message=FALSE>>=
pv <- ggplot(mpg, aes(x = displ, y = hwy)) +
    geom_point() +
    geom_smooth()
@
\end{minipage}
\begin{minipage}{5cm}
<<cp_mtcars_plot4_plot, echo=FALSE, cache=FALSE, results='show', warning=FALSE, message=FALSE, out.height='4cm', out.width='6cm'>>=
plot(pv)
@
\end{minipage}
\end{frame}
...
pv <- ggplot(aes(x = x, y = dens, colour = distrib)
            ,data = plot_dt) +
    geom_line() +
...
longterm_dt <- readRDS("data/longtermvol.dt.rds")
@
