...
SPDR S\&P 500, stock symbol SPY, given in file \texttt{spy.dat}. This
is a fund that closely tracks the S\&P 500 Index, and is the most
highly-traded stock in the world. Fit all three types of time series
to the data, and try to determine which model is the best fit.
