...
Similar to the BG/NBD model, the P/NBD model relies on five assumptions:
  ...
  distribution with shape parameter $s$ and scale parameter $$.
...
bgnbd.PlotTransactionRateHeterogeneity(params = params_btyd_bgnbd)

bgnbd.PlotDropoutRateHeterogeneity(params = params_btyd_bgnbd)
