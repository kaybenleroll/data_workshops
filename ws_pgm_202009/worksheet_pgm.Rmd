...
```{r construct_crop_bn_dag, echo=FALSE}
plant_crop_dag <- list(
    "G",
    "E",
    c("V", "G", "E"),
...
but imposes limits on the types of questions that can be ask.
...
This gives us much more flexibility in terms of the types of questions we can
ask, at the cost of producing answers that are only approximately correct.

That said, the error in this estimate is more often than not much smaller than
any errors due to the choice of the model.
